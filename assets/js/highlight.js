...
hljs.registerLanguage("cpp", function (e) {
  ...
  var r = "decltype\\(auto\\)",
    ...
    l = { cN: "title", b: t(a) + e.IR, relevance: 0 },
    u = t(a) + e.IR + "\\s*\\(",
    p = {
      keyword:
    ...
    d = {
      ...
      k: p,
      c: m.concat([
        { b: /\(/, e: /\)/, k: p, c: m.concat(["self"]), relevance: 0 },
      ]),
      relevance: 0,
    },
    b = {
  ...
  return {
    ...
    exports: { preprocessor: o, strings: s, k: p },
  };
});
